...
public class MoveWords{
    ...
    private static final String[] validMoves = {"PIEDRA", "SPOCK", "PAPEL", "LAGARTIJA", "TIJERAS"};/* Se añaden las nuevas opciones y
    se cambia el orden del array de tal manera que cada uno derrota a los dos anteriores y es derrotado por los dos posteriores*/
